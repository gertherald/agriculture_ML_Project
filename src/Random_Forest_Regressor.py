...
def run_evaluation():
    ...
    store_evaluation_metrics(database_path, 'RandomForestRegressor', mse_test, mse_baseline, r2, adjusted_r2, mae)

    # Save the trained model to a file
    joblib.dump(best_model, 'random_forest_temperature_regressor_model_trained.pkl')
