...
def fetch_cleaned_data(database_path, table_name):
    ...
    query = f"SELECT * FROM {table_name}"  # Query the cleaned data table
...
def run_evaluation():
    ...
    store_evaluation_metrics(database_path, 'GradientBoostingRegressor', mse_test, mse_baseline, r2, adjusted_r2, mae)
